...
<script type="text/javascript" src="/jquery/jquery-ui-1.12.0.custom/jquery-ui.js"></script>
...
<fieldset>
	...
	<label for="radio-13">clip</label>
	<input type="radio" name="radio-2" id="radio-13" value="clip">
	<label for="radio-14">drop</label>
	<input type="radio" name="radio-2" id="radio-14" value="drop">
	<label for="radio-15">explode</label>
	<input type="radio" name="radio-2" id="radio-15" value="explode">
	<label for="radio-16">highligit</label>
	<input type="radio" name="radio-2" id="radio-16" value="highligit">
</fieldset>
</div>
